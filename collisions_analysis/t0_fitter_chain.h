...
#ifndef t0_fitter_chain_h
#define t0_fitter_chain_h
...
class t0_fitter_chain : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TH1F *mu_eta = new TH1F("mu_eta","selected muon etas",200,-1.2,1.2);
   TH1F *mu_pt = new TH1F("mu_pt","selected muon pts",200,0,100);
   TH1F *hist_bx = new TH1F("hist_bx","BX",12,-6,6);
   TH1F *nseghist = new TH1F("segment_number_hist","segment_number_hist",20,0,20);
   TH1F *nseghist_wcuts = new TH1F("segment_number_hist_wcuts","segment_number_hist_wcuts",20,0,20);
   TH1F *nseghist_1muon = new TH1F("segment_number_hist_1muon","segment_number_hist_1muon",20,0,20);
   TF1  *myfit = new TF1("myfit","gaus(0)+pol0(3)",5,15);
   //TF1 *myfit = new TF1("myfit","pol4(0)",5,15);
   ...
   */
   ...
   t0_fitter_chain(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~t0_fitter_chain() { }
   ...
   ClassDef(t0_fitter_chain,0);
};

#endif

#ifdef t0_fitter_chain_cxx
void t0_fitter_chain::Init(TTree *tree)
{
   ...
   /*
  chain->Add("/eos/user/a/alvareza/heavy_rootfiles/DTTree_Run303832_short1.root/DTTree");
  chain->Add("/eos/user/a/alvareza/heavy_rootfiles/DTTree_Run303832_short2.root/DTTree");
   */
   // Set object pointer
   hlt_path = 0;
   digi_wheel = 0;
   ...
   */
   ...
   for(int a=0;a<4;a++) h_fits[a]= new TH1F(Form("t0_means_histogram_MB%d",a),Form("t0_means_histogram_MB%d",a),22,-2,3.5);

}

Bool_t t0_fitter_chain::Notify()
{
...
#endif // #ifdef t0_fitter_chain_cxx
